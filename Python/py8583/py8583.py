...
class Iso8583:
    ...
    def __init__(self,IsoMsg = None, IsoSpec = None):
        ...
        if(IsoMsg != None):
            ...
            self.__iso = IsoMsg
            # add by zhonghua
            print("Begin to call ParseIso(), parse bitmap & body !")
            self.ParseIso()
    ...
    def ParseField(self, field, p):
        ...
        try:
            ...
            if(LenType == LT.FIXED):
                ...
                if(LenDataType == DT.ASCII):
                    ...
                    p+=2
            # add by zhonghua
            print("Parse F{0}: MaxLength {1}, len {2}".format(field, MaxLength, Len))
        except ValueError:
        ...
        try:
            if(DataType == DT.ASCII):
                ...
                p += Len
            # add by zhonghua
            print("Parse F{0}: len [{1}] content is [{2}]".format(field, Len, self.__FieldData[field]))
